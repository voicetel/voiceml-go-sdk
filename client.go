...
// ClientOptions configures a *Client. AccountSid and APIKey are required; the
...
// or APIKey is missing, or if MaxRetries is negative.
...
// the supplied segments with a single slash. Empty segments are skipped so
// callers can pass conditional sub-resource names.
